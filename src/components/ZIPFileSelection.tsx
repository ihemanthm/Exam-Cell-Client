...
export default function ZIPFileSelection() {
  ...
  const {
    ...
    accept: {
        'application/zip': [] // For .xlsx files
    },
    onDrop: (acceptFiles) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      dispatch(
        setSnackBar({
          message: "Images upload to database successfully",
          variant: "success",
        })
      );
      setLoader(false);
      ...
      dispatch(
        setSnackBar({
          message: "Faied to upload images",
          variant: "error",
        })
      );
      setFile(null);
      ...
      <div {...getRootProps({ style })} className="file-select-box">
        ...
        {file == null ? (
          <div className="input-text">
            <span>Drag .zip file here to add them into database </span>
            <span>
              {" "}
              Or
              <Button
